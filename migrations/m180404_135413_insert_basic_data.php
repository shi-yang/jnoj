...
class m180404_135413_insert_basic_data extends BaseMigration
{
    public function up()
    {
        ...
        $this->insert('{{%problem}}', [
            ...
            'spj' => 0,
            'hint' => "Q：输入和输出在哪里？\r\n\r\nA：您的程序应始终从stdin（标准输入）读取输入，并将输出写入stdout（标准输出）。 例如，您可以使用C中的 `scanf` 或 C++中的 `cin` 从stdin中读取，并使用C中的 `printf` 或 C++ 中的 `cout` 写入 stdout。\r\n\r\n如果不是题目要求的，您不得输出任何额外的信息到标准输出，否则您会得到一个“Wrong Answer”。\r\n\r\n用户程序不允许打开和读取/写入文件。 如果您尝试这样做，您将收到“Runtime Error”或“Wrong Answer”。\r\n\r\n以下是使用 C / C++的问题1000的示例解决方案：\r\n\r\n```c\r\n#include <stdio.h>\r\nint main()\r\n{\r\n    int a, b;\r\n    scanf(\"%d %d\", &a, &b);\r\n    printf(\"%d\\n\", a + b);\r\n    return 0;\r\n}\r\n```\r\n\r\n```cpp\r\n#include <iostream>\r\nusing namespace std;\r\nint  main()\r\n{\r\n    int a, b;\r\n    cin >> a >> b;\r\n    cout << a + b << endl;\r\n    return 0;\r\n}\r\n```\r\n```\r\nimport java.util.Scanner;\r\n\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Scanner in = new Scanner(System.in);\r\n        int a = in.nextInt();\r\n        int b = in.nextInt();\r\n        System.out.println(a + b);\r\n    }\r\n}\r\n```",
            'time_limit' => 1,
            'memory_limit' => 128,
            'status' => 1,
            'created_at' => $time,
        ...
        $this->insert('{{%problem}}', [
            ...
            'input' => "第一行，输入一个整数 \$t\$，表示有 \$t\$ 组样例。\r\n\r\n接下来 \$t\$ 行，每行输入一个整数 \$n ( 1000 < n < 4000 )\$，表示需要你判断的年份。",
