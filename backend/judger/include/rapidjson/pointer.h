...
*/
    ...
    public:
        ...
        */
        ...
        //! Default constructor.
        GenericPointer()
                : allocator_(), ownAllocator_(), nameBuffer_(), tokens_(), tokenCount_(), parseErrorOffset_(),
...
//////////////////////////////////////////////////////////////////////////////
    ...
    GetValueByPointer(const T &root, const GenericPointer<typename T::ValueType> &pointer) {
        return pointer.Get(root);
    }
