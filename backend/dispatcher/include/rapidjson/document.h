...
*/
        ...
        GenericValue &AddMember(GenericValue &name, GenericValue &value, Allocator &allocator) {
            ...
            if (o.size >= o.capacity) {
                if (o.capacity == 0) {
                    ...
                    o.members = reinterpret_cast<Member *>(allocator.Realloc(o.members, oldCapacity * sizeof(Member),
    ...
    private:
        ...
        struct ShortString {
            enum {
                MaxChars = sizeof(String) / sizeof(Ch), MaxSize = MaxChars - 1, LenPos = MaxSize
            };
            Ch str[MaxChars];
...
*/
    ...
    private:
        ...
        template<typename, typename, typename> friend
        class GenericReader; // for parsing
        template<typename, typename> friend
