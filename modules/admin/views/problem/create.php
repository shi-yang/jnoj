...
<div class="problem-create">
    ...
    <hr>
    <?= Html::beginForm() ?>
    <?= Html::label(Yii::t('app', 'Problem ID'), 'polygon_problem_id') ?>
    ...
    <p class="help-block">注意：重复添加同一个位于 <?= Html::a(Yii::t('app', 'Polygon System'), ['/polygon/problem']) ?> 问题对应的 ID 会覆盖现有题库的题目内容</p>
