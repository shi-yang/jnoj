...
3. MySQL
4. SeaweedFS [https://github.com/seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs)
...
- `web` 前端项目。
- `data` 目录，**重要！重要！重要！** 通过`docker compose`启动后生成，为 docker 数据库相关数据的持久化。**注意！注意！注意！** 使用系统所有数据均储存在此目录下。
