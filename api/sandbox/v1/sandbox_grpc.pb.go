...
const (
	SandboxService_Run_FullMethodName            = "/jnoj.sandbox.v1.SandboxService/Run"
	SandboxService_RunSubmission_FullMethodName  = "/jnoj.sandbox.v1.SandboxService/RunSubmission"
	SandboxService_RunProblemFile_FullMethodName = "/jnoj.sandbox.v1.SandboxService/RunProblemFile"
	SandboxService_GetSystemInfo_FullMethodName  = "/jnoj.sandbox.v1.SandboxService/GetSystemInfo"
)
...
func (c *sandboxServiceClient) RunSubmission(ctx context.Context, in *RunSubmissionRequest, opts ...grpc.CallOption) (*RunSubmissionResponse, error) {
	...
	err := c.cc.Invoke(ctx, SandboxService_RunSubmission_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sandboxServiceClient) RunProblemFile(ctx context.Context, in *RunProblemFileRequest, opts ...grpc.CallOption) (*RunProblemFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, SandboxService_RunProblemFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sandboxServiceClient) GetSystemInfo(ctx context.Context, in *GetSystemInfoRequest, opts ...grpc.CallOption) (*GetSystemInfoResponse, error) {
	out := new(GetSystemInfoResponse)
	err := c.cc.Invoke(ctx, SandboxService_GetSystemInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSandboxServiceServer) GetSystemInfo(context.Context, *GetSystemInfoRequest) (*GetSystemInfoResponse, error) {
...
func _SandboxService_RunSubmission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_RunSubmission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SandboxService_RunProblemFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_RunProblemFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SandboxService_GetSystemInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSystemInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxServiceServer).GetSystemInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_GetSystemInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).GetSystemInfo(ctx, req.(*GetSystemInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SandboxService_GetSystemInfo_Handler,
		},
	},
