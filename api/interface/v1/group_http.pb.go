...
// auth.
// auth.
const OperationGroupServiceCreateGroup = "/jnoj.interface.v1.group.GroupService/CreateGroup"
const OperationGroupServiceCreateGroupUser = "/jnoj.interface.v1.group.GroupService/CreateGroupUser"
const OperationGroupServiceDeleteGroup = "/jnoj.interface.v1.group.GroupService/DeleteGroup"
const OperationGroupServiceDeleteGroupUser = "/jnoj.interface.v1.group.GroupService/DeleteGroupUser"
const OperationGroupServiceGetGroup = "/jnoj.interface.v1.group.GroupService/GetGroup"
const OperationGroupServiceGetGroupUser = "/jnoj.interface.v1.group.GroupService/GetGroupUser"
const OperationGroupServiceListGroupUsers = "/jnoj.interface.v1.group.GroupService/ListGroupUsers"
const OperationGroupServiceListGroups = "/jnoj.interface.v1.group.GroupService/ListGroups"
const OperationGroupServiceUpdateGroup = "/jnoj.interface.v1.group.GroupService/UpdateGroup"
const OperationGroupServiceUpdateGroupUser = "/jnoj.interface.v1.group.GroupService/UpdateGroupUser"
...
func RegisterGroupServiceHTTPServer(s *http.Server, srv GroupServiceHTTPServer) {
	s.Use("/jnoj.interface.v1.group.GroupService/CreateGroup", auth.User())
	s.Use("/jnoj.interface.v1.group.GroupService/ListGroups", auth.Guest())
	s.Use("/jnoj.interface.v1.group.GroupService/UpdateGroup", auth.User())
	s.Use("/jnoj.interface.v1.group.GroupService/GetGroup", auth.Guest())
	s.Use("/jnoj.interface.v1.group.GroupService/DeleteGroup", auth.User())
	s.Use("/jnoj.interface.v1.group.GroupService/DeleteGroupUser", auth.User())
	s.Use("/jnoj.interface.v1.group.GroupService/CreateGroupUser", auth.User())
	s.Use("/jnoj.interface.v1.group.GroupService/UpdateGroupUser", auth.User())
	r := s.Route("/")
