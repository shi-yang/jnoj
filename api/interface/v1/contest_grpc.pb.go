...
type ContestServiceClient interface {
	...
	// 创建比赛题目
	CreateContestProblem(ctx context.Context, in *CreateContestProblemRequest, opts ...grpc.CallOption) (*ContestProblem, error)
	// 获取比赛用户
	ListContestUsers(ctx context.Context, in *ListContestUsersRequest, opts ...grpc.CallOption) (*ListContestUsersResponse, error)
	// 获取比赛榜单
	ListContestStandings(ctx context.Context, in *ListContestStandingsRequest, opts ...grpc.CallOption) (*ListContestStandingsResponse, error)
}
...
func (c *contestServiceClient) CreateContest(ctx context.Context, in *CreateContestRequest, opts ...grpc.CallOption) (*Contest, error) {
	out := new(Contest)
	err := c.cc.Invoke(ctx, "/jnoj.interface.v1.ContestService/CreateContest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) CreateContestProblem(ctx context.Context, in *CreateContestProblemRequest, opts ...grpc.CallOption) (*ContestProblem, error) {
	out := new(ContestProblem)
	err := c.cc.Invoke(ctx, "/jnoj.interface.v1.ContestService/CreateContestProblem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) ListContestStandings(ctx context.Context, in *ListContestStandingsRequest, opts ...grpc.CallOption) (*ListContestStandingsResponse, error) {
	out := new(ListContestStandingsResponse)
	err := c.cc.Invoke(ctx, "/jnoj.interface.v1.ContestService/ListContestStandings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedContestServiceServer) CreateContestProblem(context.Context, *CreateContestProblemRequest) (*ContestProblem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateContestProblem not implemented")
}
...
func (UnimplementedContestServiceServer) ListContestStandings(context.Context, *ListContestStandingsRequest) (*ListContestStandingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListContestStandings not implemented")
}
...
func _ContestService_CreateContest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jnoj.interface.v1.ContestService/CreateContest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ContestService_CreateContestProblem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateContestProblemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContestServiceServer).CreateContestProblem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jnoj.interface.v1.ContestService/CreateContestProblem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContestServiceServer).CreateContestProblem(ctx, req.(*CreateContestProblemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ContestService_ListContestStandings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListContestStandingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContestServiceServer).ListContestStandings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jnoj.interface.v1.ContestService/ListContestStandings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContestServiceServer).ListContestStandings(ctx, req.(*ListContestStandingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ContestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateContestProblem",
			Handler:    _ContestService_CreateContestProblem_Handler,
		},
		{
		...
		{
			MethodName: "ListContestStandings",
			Handler:    _ContestService_ListContestStandings_Handler,
		},
	},
