...
type SubmissionServiceClient interface {
	...
	// 提交的运行信息
	GetSubmissionInfo(ctx context.Context, in *GetSubmissionInfoRequest, opts ...grpc.CallOption) (*SubmissionInfo, error)
}
...
func (c *submissionServiceClient) GetSubmissionInfo(ctx context.Context, in *GetSubmissionInfoRequest, opts ...grpc.CallOption) (*SubmissionInfo, error) {
	out := new(SubmissionInfo)
	err := c.cc.Invoke(ctx, "/jnoj.interface.v1.SubmissionService/GetSubmissionInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSubmissionServiceServer) GetSubmissionInfo(context.Context, *GetSubmissionInfoRequest) (*SubmissionInfo, error) {
...
func _SubmissionService_GetSubmissionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jnoj.interface.v1.SubmissionService/GetSubmissionInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SubmissionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SubmissionService_GetSubmissionInfo_Handler,
		},
	},
